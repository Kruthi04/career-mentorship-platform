    ...
    <div className="w-full bg-white">
      ...
      <section className="relative text-white py-16">
        <div className="absolute inset-0 z-0">
          <img
            src="https://images.unsplash.com/photo-1573497491765-dccce02b29df?ixlib=rb-1.2.1&auto=format&fit=crop&w=2000&q=80"
              ...
              <div className="bg-white rounded-lg shadow-md p-8">
                ...
                <div className="flex justify-between mt-8">
                  ...
                  <button
                    onClick={nextStep}
                    disabled={
                      !interviewType || !industry || !jobTitle || !experience
                    }
              ...
              <div className="bg-white rounded-lg shadow-md p-8">
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="block w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    placeholder="E.g., I struggle with behavioral questions about conflict resolution, or I need help with system design questions."
                  ></textarea>
                </div>
