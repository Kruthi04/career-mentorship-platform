...
const reviewers: Reviewer[] = [
  {
    ...
    reviews: 127,
    experience:
      "10+ years in HR and recruitment across tech, finance, and healthcare industries",
    specialties: [
      "ATS Optimization",
      "Executive Resumes",
      "Career Transitions",
  ...
  },
  {
    ...
    reviews: 89,
    experience:
      "8 years specializing in software engineering and product management roles",
    specialties: ["Tech Resumes", "Startup Experience", "Product Management"],
  },
  {
    id: 3,
    ...
    reviews: 156,
    experience:
      "12 years helping professionals advance their careers and land dream jobs",
    specialties: ["Career Changes", "Entry Level", "Mid-Career Advancement"],
  },
];
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
                          ...
                          <div className="flex flex-col items-center">
                            ...
                            <div className="flex mt-4 space-x-2">
                              <a
                                ...
                                className="px-3 py-1 text-sm text-blue-700 border border-blue-700 rounded-md hover:bg-blue-50 flex items-center"
                              >
                  ...
                  <div className="mb-8">
                    ...
                    <div className="mt-1 relative rounded-md shadow-sm">
                      ...
                      <input
                        ...
                        className="block w-full pl-10 pr-12 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            {/* Step 2: Choose Reviewer */}

            {step === 2 && (
              <div className="bg-white rounded-lg shadow-md p-8">
                <h2 className="text-2xl font-bold text-gray-800 mb-6">
                  Choose Your Resume Reviewer
                </h2>
              ...
              <div className="bg-white rounded-lg shadow-md p-8">
                ...
                <div className="flex justify-between mt-8">
                  ...
                  <button
                    onClick={submitForm}
                    disabled={
                      !industry || !experience || !targetRole || !priority
                    }
                    className={`px-6 py-2 rounded-md ${
                      industry && experience && targetRole && priority
                        ? "bg-blue-600 text-white hover:bg-blue-700"
              ...
              <div className="bg-white rounded-lg shadow-md p-8">
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600">
                    ...
                    {selectedReviewer &&
                      reviewers.find((r: Reviewer) => r.id === selectedReviewer)
                        ?.name}{" "}
                    will review it and provide feedback within 48 hours.
                  </p>
                </div>
                {feedback && (
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        ...
                        <p>Our expert will carefully review your resume</p>
                      </li>
                      <li className="flex items-start">
                        <span className="flex-shrink-0 w-6 h-6 bg-blue-200 rounded-full flex items-center justify-center mr-3 mt-0.5 text-blue-800">
                          2
                        ...
                        <p>
                          You'll receive an email with detailed feedback within
                          48 hours
                        </p>
                      </li>
                      <li className="flex items-start">
                        ...
                        <p>
                          Schedule a follow-up consultation to discuss the
                          recommendations
                        </p>
                      </li>
                    </ul>
